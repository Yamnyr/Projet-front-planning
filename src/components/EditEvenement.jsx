...
export function Form() {
    ...
    const [Evenement, setEvenement] = useState({ lib_evenement: "", date_evenement: "", desc_evenement: "", concerne: []});
    ...
    useEffect(() => {
        fetchEvenementById(idEvenement).then((data) => {
            ...
            setEvenement({ lib_evenement: data.lib_evenement, date_evenement: formattedDate, desc_evenement: data.desc_evenement, concerne:[]});
        });
    }, [idEvenement]);
    ...
    function editEvent({Evenement}) {
        api
            .put(`/api/evenements/${idEvenement}`, {Evenement
            })
            .then((response) => {
    ...
    return (
        <form className="form-evenement" onSubmit={handleSubmit}>
            ...
            <input
                ...
                onChange={(e) => setEvenement({...Evenement, lib_evenement: e.target.value})}
            />
            <label>Date</label>
            <input
                name="date"
                ...
                onChange={(e) => setEvenement({...Evenement, date_evenement: e.target.value})}
            />
            ...
            <textarea
                ...
                onChange={(e) => setEvenement({...Evenement, desc_evenement: e.target.value})}
            />
